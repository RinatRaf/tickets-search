      ...
      <div className={styles.wrap}>
        ...
        <div>
          <div className={styles.header}>
            <h2>{data.title}</h2>
            {isAuth ? <StarRating filmId={data.id} /> : ""}
          </div>
          <div className={styles.discWrap}>
            <p className={styles.discTitle}>
              <b>Жанр:</b>
            </p>
            <p className={styles.discValue}>{data.genre}</p>
          </div>
          <div className={styles.discWrap}>
            <p className={styles.discTitle}>
              <b>Год выпуска:</b>
            </p>
            <p className={styles.discValue}>{data.release_year}</p>
          </div>
          <div className={styles.discWrap}>
            <p className={styles.discTitle}>
              <b>Рейтинг:</b>
            </p>
            <p className={styles.discValue}>{data.rating}</p>
          </div>
          <div className={styles.discWrap}>
            <p>
              <b>Описание:</b>
